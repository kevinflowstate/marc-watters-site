...
const navItems = [
  ...
  { href: "/portal/plan", label: "Business Plan", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" },
  ...
  { href: "/portal/ai", label: "Blueprint AI", icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" },
  { href: "/portal/growth-engine", label: "CBB Growth Engine", icon: "M4 19V9m5 10V5m5 14v-7m5 7V3M3 19h18" },
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside className="portal-sidebar portal-v2-sidebar hidden lg:flex fixed top-0 left-0 h-full w-[260px] backdrop-blur-[20px] z-50 flex-col">
        <div className="px-5 py-6 border-b border-[rgba(255,255,255,0.06)]">
          <Link href="/" className="flex items-center gap-3 no-underline">
            ...
            <div className="min-w-0">
              ...
              <div className="font-heading text-sm font-extrabold text-text-primary">Blueprint Portal</div>
            </div>
          </Link>
        </div>

        <nav className="flex-1 px-3 py-5 flex flex-col gap-1.5" aria-label="Client portal">
          {navItems.map((item) => {
        ...
        {/* Notification bell */}
        <div ref={notificationRef} className="px-4 pb-2 relative">
          <button
            onClick={() => {
        ...
        <div className="p-3 border-t border-[rgba(255,255,255,0.06)]">
          <div className="flex items-center gap-3 rounded-xl border border-[rgba(255,255,255,0.05)] bg-white/[0.02] px-3 py-3">
            {avatarUrl ? (
            ...
            <div className="min-w-0">
              <div className="truncate text-sm font-semibold text-text-primary">{userName || "Loading..."}</div>
              <div className="text-[11px] text-text-muted">Client account</div>
            </div>
          </div>
