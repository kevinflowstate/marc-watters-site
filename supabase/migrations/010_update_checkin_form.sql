-- Replace the weekly client check-in with Marc's latest question set
-- while keeping submissions native to the portal.

INSERT INTO public.form_config (form_type, config, updated_at)
VALUES (
  'checkin',
  $${
    "checkin_day": "monday",
    ...
    "questions": [
      ...
      },
      {
        ...
        "required": true,
        "options": [
          { "value": "great", "label": "Fantastic - I'm energised, things are flowing, I'm in control" },
          { "value": "good", "label": "Good - Steady progress, mostly on track, minor concerns" },
          { "value": "struggling", "label": "Struggling - There's friction, I'm stretched, need to fix some things" },
          { "value": "awful", "label": "Awful - I need help, this isn't working, feeling overwhelmed" }
        ]
      },
      {
        "id": "what_went_well",
