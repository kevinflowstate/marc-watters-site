...
export default function AdminBlueprintAIPage() {
  ...
  return (
    <div className="flex min-h-0 flex-col overflow-hidden h-[calc(100vh-2rem)] max-w-3xl mx-auto">
      <div className="mb-6">
      ...
      <div ref={scrollAreaRef} className="flex-1 min-h-0 overflow-y-auto p-4 mb-4">
