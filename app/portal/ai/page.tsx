...
export default function BlueprintAIPage() {
  ...
  return (
    <div className="flex min-h-0 flex-col overflow-hidden h-[calc(100dvh-8rem)] lg:h-[calc(100vh-4rem)] max-w-3xl mx-auto">
      <div className="mb-6">
      ...
      <div
        ref={scrollAreaRef}
        className="flex-1 min-h-0 overflow-y-auto p-4 mb-4 bg-[rgba(255,255,255,0.01)] rounded-2xl border border-[rgba(255,255,255,0.03)]"
      >
