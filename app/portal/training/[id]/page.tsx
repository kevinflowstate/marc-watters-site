    ...
    <>
      ...
      <div className="space-y-2">
        {lessons.map((lesson, i) => {
          ...
          return (
            <div key={lesson.id} className="bg-bg-card/80 backdrop-blur-sm border border-[rgba(255,255,255,0.04)] rounded-2xl overflow-hidden transition-all duration-200 hover:border-[rgba(255,255,255,0.08)]">
              {/* Lesson row */}
              <button
