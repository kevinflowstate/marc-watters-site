...
export const metadata: Metadata = {
  title: "12 Month Programme - Deposit | Construction Business Blueprint",
  description: "Secure your place on the 12 month Construction Business Blueprint programme with a deposit.",
};

export default function Pay12MonthDepositPage() {
  return (
        ...
        <div className="bg-bg-card border border-[rgba(255,255,255,0.06)] rounded-[20px] overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.4),0_0_60px_rgba(34,114,222,0.04)] relative">
          ...
          <div className="p-10">
            ...
            <p className="text-text-secondary text-center mb-8">
              12 months of private mentorship - deposit
            </p>
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-text-muted text-sm mt-2">Deposit</p>
            </div>

            {/* Payment breakdown */}
            <div className="bg-[rgba(34,114,222,0.04)] border border-[rgba(34,114,222,0.1)] rounded-xl p-5 mb-8">
              <div className="text-xs font-semibold text-accent-bright uppercase tracking-[0.5px] mb-3">Payment Breakdown</div>
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-text-secondary">Deposit today</span>
                  <span className="text-text-primary font-medium">&pound;1,600</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-text-secondary">Remaining balance</span>
                  <span className="text-text-primary font-medium">&pound;6,400</span>
                </div>
              </div>
            </div>
            ...
            <ul className="space-y-3 mb-10">
              {[
                "12 months private mentorship with Marc",
            ...
            {/* CTA */}
            <a
              href="https://link.constructionbusinessblueprint.co.uk/payment-link/69b2e60492346e17038ac3b4"
