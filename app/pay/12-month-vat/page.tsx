...
export const metadata: Metadata = {
  title: "12 Month Programme - Pay in Full (Incl. VAT) | Construction Business Blueprint",
  description: "Secure your place on the 12 month Construction Business Blueprint programme.",
};

export default function Pay12MonthVatPage() {
  return (
        ...
        <div className="bg-bg-card border border-[rgba(255,255,255,0.06)] rounded-[20px] overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.4),0_0_60px_rgba(34,114,222,0.04)] relative">
          ...
          <div className="p-10">
            ...
            <p className="text-text-secondary text-center mb-8">
              12 months of private mentorship - pay in full (incl. VAT)
            </p>
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-text-muted text-sm mt-2">£8,000 + £1,600 VAT</p>
            </div>
            ...
            {/* CTA */}
            <a
              href="https://link.constructionbusinessblueprint.co.uk/payment-link/69b2d8d292346e17038ac389"
