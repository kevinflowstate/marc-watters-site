...
export const metadata: Metadata = {
  title: "6 Month Programme - Deposit (Incl. VAT) | Construction Business Blueprint",
  description: "Secure your place on the 6 month Construction Business Blueprint programme.",
};

export default function Pay6MonthDepositVatPage() {
  return (
        ...
        <div className="bg-bg-card border border-[rgba(255,255,255,0.06)] rounded-[20px] overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.4),0_0_60px_rgba(34,114,222,0.04)] relative">
          ...
          <div className="p-10">
            ...
            <p className="text-text-secondary text-center mb-8">
              6 months of private mentorship - deposit (incl. VAT)
            </p>
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-text-muted text-sm mt-2">Deposit (£1,000 + £200 VAT)</p>
            </div>
            ...
            <div className="bg-[rgba(34,114,222,0.04)] border border-[rgba(34,114,222,0.1)] rounded-xl p-5 mb-8">
              ...
              <div className="space-y-2">
                {[
                  { label: "Deposit today", amount: "£1,200" },
                  { label: "Remaining balance", amount: "£4,800" },
                ].map(({ label, amount }) => (
            ...
            {/* CTA */}
            <a
              href="https://link.constructionbusinessblueprint.co.uk/payment-link/69b2d7f78e8f54b631536b6c"
