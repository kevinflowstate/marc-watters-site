...
export const metadata: Metadata = {
  title: "6 Month Programme - Split Pay | Construction Business Blueprint",
  description: "Secure your place on the 6 month Construction Business Blueprint programme with split payments.",
};

export default function Pay6MonthSplitPage() {
  return (
        ...
        <div className="bg-bg-card border border-[rgba(255,255,255,0.06)] rounded-[20px] overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.4),0_0_60px_rgba(34,114,222,0.04)] relative">
          ...
          <div className="p-10">
            ...
            <p className="text-text-secondary text-center mb-8">
              6 months of private mentorship - split payment
            </p>
            ...
            <div className="bg-[rgba(34,114,222,0.04)] border border-[rgba(34,114,222,0.1)] rounded-xl p-5 mb-8">
              ...
              <div className="space-y-2">
                {["Payment 1 - Today", "Payment 2 - Week 2", "Payment 3 - Week 3", "Payment 4 - Week 4"].map((label) => (
                  <div key={label} className="flex justify-between text-sm">
                    <span className="text-text-secondary">{label}</span>
                    <span className="text-text-primary font-medium">£675</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            {/* CTA */}
            <a
              href="https://link.constructionbusinessblueprint.co.uk/payment-link/69b2a2237b7a1f7aeeb2819b"
